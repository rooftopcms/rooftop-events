...
class WP_REST_Events_Controller extends WP_REST_Controller {
     ...
     */
    protected function prepare_event_for_database( $request ) {
     ...
     */
    public function prepare_event_for_response( $post, $request ) {
        $GLOBALS['post'] = $post;
        setup_postdata( $post );
    ...
    public function prepare_event_instance_for_response( $post, $request ) {
        $GLOBALS['post'] = $post;
        setup_postdata( $post );
